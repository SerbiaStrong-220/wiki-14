...
!!! info "Содержание"
	1. [Иерархия командования](#title1)
	2. [Общие СРП Командования](#title2)   
		2.1 [СРП Главы отдела](#title2.1)    
		2.2 [СРП Капитана](#title2.2)  
		2.3 [СРП Главы Персонала](#title2.3)   
		2.4 [СРП офицера "Синий Щит"](#title2.4)  
	3. [Процедуры и протоколы Командования](#title3)  
		3.1 [Процедура назначения ВрИО Капитана](#title3.1)   
		3.2 [Процедура отстранения Капитана от командования](#title3.2)  
		3.3 [Процедура назначения ВрИО главы отдела](#title3.3)  
		3.4 [Процедура отстранения ВрИО главы отдела](#title3.4)   
		3.5 [Процедуры изменения доступов](#title3.5)   
		&nbsp; 3.5.1 [Политика назначения на должность](#title3.5.1)  
		&nbsp; 3.5.2 [Политика повышения/перевода на другую должность](#title3.5.2)  
		&nbsp; 3.5.3 [Процедура выдачи доступов](#title3.5.3)  
		&nbsp; 3.5.4 [Политика снятия с должности](#title3.5.4)  
		&nbsp; 3.5.5 [Процедура снятия доступов](#title3.5.5)  
		&nbsp; 3.5.6 [Причины отстранения от должности](#title3.5.6)  
		3.6 [Протоколы эвакуации](#title3.6)   
	
# <a id="title1">Иерархия командования</a>
